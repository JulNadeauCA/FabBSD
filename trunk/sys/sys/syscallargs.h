...
struct sys_spinctl_args {
	...
	syscallarg(int) op;
	syscallarg(const struct cnc_spindle_args *) args;
};

struct sys_atcctl_args {
	syscallarg(int) atc;
	syscallarg(int) op;
	syscallarg(const struct cnc_atc_args *) args;
};

struct sys_laserctl_args {
	syscallarg(int) laser;
	syscallarg(int) op;
	syscallarg(const struct cnc_laser_args *) args;
};

struct sys_pickplacectl_args {
	syscallarg(int) pp;
	syscallarg(int) op;
	syscallarg(const struct cnc_pickplace_args *) args;
};

struct sys_coolantctl_args {
	syscallarg(int) coolant;
	syscallarg(int) op;
	syscallarg(int) val;
};
