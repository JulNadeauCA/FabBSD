# hints/fabbsd.sh
#
# hints file for FabBSD; Julien Nadeau <vedge@hypertriton.com>
# Edited to allow Configure command-line overrides by
#  Andy Dougherty <doughera@lafayette.edu>
#
# To build with distribution paths, use:
#	./Configure -des -Dfabbsd_distribution=defined
#

# FabBSD has a better malloc than perl...
...
# FabBSD doesn't need libcrypt but many folks keep a stub lib
...
# When building in the FabBSD tree we use different paths
# This is only part of the story, the rest comes from config.over
case "$fabbsd_distribution" in
''|$undef|false) ;;
*)
