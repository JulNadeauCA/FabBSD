...
#define TARGET_VERSION fprintf (stderr, " (FabBSD/i386)");
...
/* i386 FabBSD still uses an older gas that doesn't insert nops by default
...
/* FabBSD gas currently does not support quad, so do not use it.  */
#undef ASM_QUAD
