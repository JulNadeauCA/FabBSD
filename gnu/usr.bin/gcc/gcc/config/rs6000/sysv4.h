...
do {									\
  ...
  if (!strcmp (rs6000_abi_name, "sysv"))				\
    ...
    rs6000_current_abi = ABI_V4;					\
  else if (!strcmp (rs6000_abi_name, "fabbsd"))				\
    rs6000_current_abi = ABI_V4;					\
...
%{mcall-fabbsd: %(link_start_fabbsd) } \
%{mcall-gnu: %(link_start_gnu) } \
%{mcall-netbsd: %(link_start_netbsd) } \
%{!mads: %{!myellowknife: %{!mmvme: %{!msim: %{!mwindiss: \
         %{!mcall-linux: %{!mcall-fabbsd: %{!mcall-openbsd: \
	 %{!mcall-gnu: %{!mcall-netbsd: %{!mcall-freebsd: \
	 %(link_start_default) }}}}}}}}}}}"
...
%{mcall-fabbsd: %(link_os_fabbsd) } \
%{mcall-gnu: %(link_os_gnu) } \
%{mcall-netbsd: %(link_os_netbsd) } \
%{!mads: %{!myellowknife: %{!mmvme: %{!msim: %{!mwindiss: \
         %{!mcall-freebsd: %{!mcall-linux: %{!mcall-fabbsd: %{!mcall-openbsd: \
	 %{!mcall-gnu: %{!mcall-netbsd: %(link_os_default) }}}}}}}}}}}"
...
%{mcall-fabbsd: %(cpp_os_fabbsd) } \
%{mcall-linux: %(cpp_os_linux) } \
%{mcall-gnu: %(cpp_os_gnu) } \
%{mcall-netbsd: %(cpp_os_netbsd) } \
%{!mads: %{!myellowknife: %{!mmvme: %{!msim: %{!mwindiss: \
         %{!mcall-freebsd: %{!mcall-linux: %{!mcall-fabbsd: %{!mcall-openbsd: \
	 %{!mcall-gnu: %{!mcall-netbsd: %(cpp_os_default) }}}}}}}}}}}"
...
%{mcall-fabbsd: %(startfile_fabbsd) } \
%{mcall-gnu: %(startfile_gnu) } \
%{mcall-netbsd: %(startfile_netbsd) } \
%{!mads: %{!myellowknife: %{!mmvme: %{!msim: %{!mwindiss: \
         %{!mcall-freebsd: %{!mcall-linux: %{!mcall-fabbsd: %{!mcall-openbsd: \
	 %{!mcall-gnu: %{!mcall-netbsd: %(startfile_default) }}}}}}}}}}}"
...
%{mcall-fabbsd: %(lib_fabbsd) } \
%{mcall-gnu: %(lib_gnu) } \
%{mcall-netbsd: %(lib_netbsd) } \
%{!mads: %{!myellowknife: %{!mmvme: %{!msim: %{!mwindiss: \
         %{!mcall-freebsd: %{!mcall-linux: %{!mcall-fabbsd: %{!mcall-openbsd: \
	 %{!mcall-gnu: %{!mcall-netbsd: %(lib_default) }}}}}}}}}}}"
...
%{mcall-fabbsd: crtsavres.o%s %(endfile_fabbsd) } \
%{mcall-gnu: crtsavres.o%s %(endfile_gnu) } \
%{mcall-netbsd: crtsavres.o%s %(endfile_netbsd) } \
%{mvxworks: crtsavres.o%s %(endfile_vxworks) } \
%{!mads: %{!myellowknife: %{!mmvme: %{!msim: %{!mwindiss: \
         %{!mcall-freebsd: %{!mcall-linux: %{!mcall-fabbsd: %{!mcall-openbsd: \
	 %{!mcall-gnu: %{!mcall-netbsd: %{!mvxworks: %(crtsavres_default) \
                                       %(endfile_default) }}}}}}}}}}}}"
...
/* FabBSD support.  */
#ifndef	LIB_FABBSD_SPEC
#define LIB_FABBSD_SPEC "%{mnewlib: --start-group %(libc_fabbsd) --end-group } %{!mnewlib: %(libc_fabbsd) }"
#endif

#ifndef LIBC_FABBSD_SPEC
#define LIBC_FABBSD_SPEC "%{!shared:%{pthread:-lpthread%{p:_p}%{!p:%{pg:_p}}}} %{!shared:-lc%{p:_p}%{!p:%{pg:_p}}}"
#endif

#ifndef	STARTFILE_FABBSD_SPEC
#define	STARTFILE_FABBSD_SPEC "\
%{!shared: %{pg:gcrt0.o%s} %{!pg:%{p:gcrt0.o%s} %{!p:crt0.o%s}}} \
%{mnewlib: ecrti.o%s} \
%{!mnewlib: %{!shared:crtbegin.o%s} %{shared:crtbeginS.o%s}}"
#endif
...
#ifndef	ENDFILE_FABBSD_SPEC
#define	ENDFILE_FABBSD_SPEC "\
%{mnewlib: ecrtn.o%s} \
%{!mnewlib: %{!shared:crtend.o%s} %{shared:crtendS.o%s}}"
#endif
/*
...
#ifndef LINK_START_FABBSD_SPEC
#define LINK_START_FABBSD_SPEC "-Ttext 0x400074"
#endif

#ifndef LINK_OS_FABBSD_SPEC
#define LINK_OS_FABBSD_SPEC ""
#endif

#ifndef CPP_OS_FABBSD_SPEC
#define CPP_OS_FABBSD_SPEC FABBSD_CPP_SPEC
#endif
...
#define	SUBTARGET_EXTRA_SPECS						\
  ...
  { "lib_fabbsd",		LIB_FABBSD_SPEC },			\
  { "libc_fabbsd",		LIBC_FABBSD_SPEC },			\
  ...
  { "startfile_fabbsd",		STARTFILE_FABBSD_SPEC },		\
  ...
  { "endfile_fabbsd",		ENDFILE_FABBSD_SPEC },			\
  ...
  { "link_start_fabbsd",	LINK_START_FABBSD_SPEC },		\
  ...
  { "link_os_fabbsd",		LINK_OS_FABBSD_SPEC },			\
  ...
  { "cpp_os_fabbsd",		CPP_OS_FABBSD_SPEC },			\
