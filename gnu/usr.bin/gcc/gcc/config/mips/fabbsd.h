/* Configuration for  a Mips ABI32 FabBSD target.
...
/* Definitions needed for FabBSD, to avoid picking mips 'defaults'.  */

/* GAS must know this.  */
#define SUBTARGET_ASM_SPEC "%{fPIC:-KPIC} %|"

/* CPP specific FabBSD specs.  */
...
/* Get generic FabBSD definitions.  */
#define FABBSD_HAS_DECLARE_FUNCTION_NAME
#define FABBSD_HAS_DECLARE_OBJECT
